...
"""
    ...
    def load_font_settings(self):
        ...
        读取字体配置文件，该文件包含UI字体、地图字体和大地图字体的路径设置。配置文件位于"D:\Doiiars\Game\cataclysmdda\data\fontdata.json"。
...
"""
    ...
    def update_font_settings(self, font_key, filepath):
        ...
        if isinstance(font_key, list):
            for key in font_key:
                self.fontsjson[key][0] = target_filepath
        else:
            self.fontsjson[font_key][0] = target_filepath
